                ...
                <Box sx={{
                        ...
                        <Grid item xs={12} sm={5} md={8}>
                            ...
                            <Paper elevation={5} sx={{ padding: '2% 4% ', width: '80%', marginBottom: '1rem' }}>
                                <Typography id="modal-modal-title" sx={home.homeTextH2LeftLight}>
                                    ¿Para qué sirve la solicitud de Variación de Aporte Personal?
                                </Typography>
                                <Typography id="modal-modal-description" sx={home.homeTextH4Left}>Permite a un trabajador solicitar un cambio en la cantidad de dinero que se deduce de su salario para contribuciones a la seguridad social, como el seguro de salud o el sistema de pensiones.<br /> Esto puede tener varios propósitos, dependiendo del sistema de seguridad social o de pensiones y de las regulaciones locales o nacionales.
                                </Typography>
                            </Paper>
                    ...
                    <Box display="flex" justifyContent="space-around" alignItems="center" sx={{ margin: '0 15%' }} >
                        ...
                        <Card sx={account.formularyFormatCardLoan}  >
                            <CardActionArea>
                                ...
                                <CardContent >
                                    <Box display="flex" flexDirection={'column'} >
                                        <Typography variant="subtitle1" sx={home.homeTextH3}>Variación de Aporte</Typography>
                            ...
                            <CardActions >
                                <Box margin={'0 18%'} >
                                    <Button variant="contained" color="secondary" sx={buttons.accountVariationButton}
                                        onClick={() => handleClickDownloadDocuments('/files/variacion_aporte.pdf', "variacion_aporte.pdf")}>
                                        Descargar archivo
                                    </Button>
                                </Box>
                            </CardActions>
